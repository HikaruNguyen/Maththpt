...
fc.datepickerLang = function(langCode, datepickerLangCode, options) {
	...
	mergeOptions(langOptions, {
		...
		defaultButtonText: {
			// the translations sometimes wrongly content HTML entities
...
$.extend(TimeGrid.prototype, {
	...
	eventSkeletonEl: null, // has cells with event-containers, which content absolutely positioned event elements
