describe 'Morris.Bar', ->
  describe 'when using vertical grid', ->
    ...
    describe 'svg structure', ->
      it 'should content extra rectangles for vertical grid', ->
  ...
  describe 'svg structure', ->
    ...
    it 'should content a rect for each bar', ->
      chart = Morris.Bar $.extend {}, defaults
      $('#graph').find("rect").size().should.equal 4

    it 'should content 5 grid lines', ->
      chart = Morris.Bar $.extend {}, defaults
      $('#graph').find("path").size().should.equal 5

    it 'should content 7 text elements', ->
      chart = Morris.Bar $.extend {}, defaults
  ...
  describe 'when setting bar radius', ->
    describe 'svg structure', ->
      ...
      it 'should content a path for each bar', ->
        chart = Morris.Bar $.extend {}, defaults
