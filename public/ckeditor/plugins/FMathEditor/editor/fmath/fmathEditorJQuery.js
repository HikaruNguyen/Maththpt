FMATH.ApplicationConfiguration.setFolderUrlForFonts("fmath/fonts");
FMATH.ApplicationConfiguration.setFolderUrlForGlyphs("fmath/glyphs");
...
$.widget("fmath.mathEditor", {
	...
	options : {
		width : 800,
		height : 500,
		//saveImageOnServer:true,
		//saveImageOnServerUrl:'/capture/saveImageAndMathML.jsp?param1=value',
		selectedOverColor:'#F1948A',
		...
		constantSymboles: "30,31,2148,3C0,1D486,3B3,3C6,39B,3B2,3BB,3C3,1D647,3A9,3BC,39A,3B8,3C1,3B1,1D641,3A8,3B4"
	},
