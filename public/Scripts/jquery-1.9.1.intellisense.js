intellisense.annotate(jQuery, {
  ...
  'contains': function() {
    ...
    ///   <param name="container" type="Element">The DOM element that may content the other element.</param>
...
intellisense.annotate(jQuery.fn, {
  ...
  'contains': function() {
    /// <signature>
    ///   <summary>Select all elements that content the specified text.</summary>
  ...
  'live': function() {
    ...
    ///   <param name="events" type="String">A string containing a JavaScript event type, such as "click" or "keydown." As of jQuery 1.4 the string can content multiple, space-separated event types or custom event names.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
