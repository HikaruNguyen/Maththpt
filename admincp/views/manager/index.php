...
if (isset($_SESSION['token'])) {
    ...
    $sql_get_count = "SELECT count(tbl_manager.id) as SL from " . CRUDUtils::$DB_MANAGER . " where tbl_manager.type<>0";
    $sql = "SELECT tbl_manager.id, tbl_manager.username, tbl_manager.fullname, tbl_manager.email, tbl_manager.type 
            FROM " . CRUDUtils::$DB_MANAGER . " where tbl_manager.type<>0";
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-bookmark"></i>Quản lý quản trị viên
                    </div>
